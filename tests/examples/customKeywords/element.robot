...
Resource         ../../../PO/examples/customKeywords/elementPage.robot                 # Importing Page Object File for element page
...
Verify Element Exist And It Is Only One In the DOM Three        # Test case to verify the existence and uniqueness of an element in the DOM tree
    [Tags]    examples    customKeywords    element             # Tagging the test case for classification
