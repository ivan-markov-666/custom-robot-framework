...
Resource         ../../../PO/examples/elements/clickItPage.robot         # Includes clickItPage file (Page Object Files)
...
Verify Element Exist And Click On It
    [Tags]    examples    elements    clickIt                            # Tags help categorize tests; useful for selective test execution
